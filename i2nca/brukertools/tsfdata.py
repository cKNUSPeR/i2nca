...
dll.tsf_read_line_spectrum_with_width_v2.argtypes = [c_uint64, c_int64, POINTER(c_double), POINTER(c_float),
...
class TsfData:
    ...
    def readLineSpectrum(self, frame_id):
        ...
        while True:
            ...
            required_len = self.dll.tsf_read_line_spectrum_v2(self.handle, frame_id,
    ...
    def readLineSpectrumWithWidth(self, frame_id):
        ...
        while True:
            ...
            required_len = self.dll.tsf_read_line_spectrum_with_width_v2(
                self.handle, frame_id, index_buf.ctypes.data_as(POINTER(c_double)),
                intensity_buf.ctypes.data_as(POINTER(c_float)), width_buf.ctypes.data_as(POINTER(c_float)),
                self.profile_buffer_size)
    ...
    def readProfileSpectrum(self, frame_id):
        ...
        while True:
            ...
            required_len = self.dll.tsf_read_profile_spectrum_v2(self.handle, frame_id,
